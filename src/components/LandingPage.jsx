        ...
        <div className="min-h-screen text-white">
            ...
            <section className="relative h-screen bg-center bg-cover" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-70">
                    <div className="max-w-7xl mx-auto px-4 text-center md:px-10 lg:px-20">
            ...
            <section className=" px-4 py-10 mx-auto text-black bg-white">
                <Slide direction="up" triggerOnce>
                    <div className="max-w-7xl mx-auto grid grid-cols-2 gap-8 text-center md:grid-cols-4">
                        <div className="p-4">
            ...
            <section className=" px-4 py-16 mx-auto bg-gray-900">
                <div>
            ...
            <section className=" relative px-4 py-20 mx-auto overflow-hidden text-black bg-white">
            ...
            <section className=" relative px-4 py-20 mx-auto overflow-hidden text-white bg-gray-900">
            ...
            <section className=" px-4 py-16 mx-auto text-black bg-white">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    {(upcomingEvents.length > 0 ? upcomingEvents : pastEvents.slice(0, 4)).map((event) => (
                        <div key={event._id} className="p-6 text-center transition transform bg-gray-100 rounded-lg shadow-lg hover:scale-105">
                            <img 
                                src={`https://isa-matara-api-2005-batch.vercel.app${event.imageUrl}`} 
                                alt={event.title} 
            ...
            <section className=" relative px-6 py-20 mx-auto text-black bg-white">
